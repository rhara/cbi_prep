...
run obabel ${ligname}.pdb -O ${ligname}.mol2
...
run smina -r ${pdbid}_apo_H_charged.mol2 -l ${ligname}.mol2 --cpu ${ncpu} $(python center.py ${ligname}.pdb) --num_modes ${npose} -o ${ligname}_redock.sdf --seed 0 --log ${pdbid}_smina.log
run python rmsd.py ${ligname}.pdb ${ligname}_redock.sdf
