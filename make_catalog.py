...
def get_hsgw_selections():
    df = pd.read_csv('pdb2018_kd_select.csv')
    return set(df['PDB_code'])

def get_index_data(iname, kinases, selects, src):
...
def main():
    ...
    selects = get_hsgw_selections()
    data_2018 = get_index_data('INDEX_general_PL_data.2018', kinases, selects, '2018')
    data_2019 = get_index_data('INDEX_general_PL_data.2019', kinases, selects, '2019')
